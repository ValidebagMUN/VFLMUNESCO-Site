    ...
    <!-- <div class="hero text-neutral overflow-clip">
        <div class="flex-col hero-content lg:flex-row">
            <div>
                ...
                <div class="container flex flex-col items-center justify-center lg:flex-row">
                    <TeamCard img="/img/team/ruya.jpg" name="Zeynep Rüya Özdemir" title="Academic Advisor" />
                    <TeamCard img="/img/team/eylul.jpg" name="Eylül Kalkan" title="Academic Advisor" />
                </div>
            </div>
        </div>
    </div> -->

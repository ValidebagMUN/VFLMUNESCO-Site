...
useSchemaOrg([
    ...
    defineQuestion({
        ...
        answer: 'The venue of ValidebağTrain is set to be Validebağ Science High School. For information on how to reach the venue, please check our <a href="/venue" class="link">venue page</a>.'
    }),
    defineQuestion({
        question: 'What is the schedule of ValidebağTrain?',
        answer: 'The scheduled date of this years edition of ValidebağTrain is 11-12 October 2025. <a href="/schedule" class="link">here</a>.'
    }),
    defineQuestion({
